...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { ano_publ: @livro.ano_publ, autor: @livro.autor, quantidade: @livro.quantidade, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano_publ: @livro.ano_publ, autor: @livro.autor, quantidade: @livro.quantidade, titulo: @livro.titulo } }
