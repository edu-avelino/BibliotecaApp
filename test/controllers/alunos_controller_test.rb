...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { Data_Nasc: @aluno.Data_Nasc, email: @aluno.email, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { Data_Nasc: @aluno.Data_Nasc, email: @aluno.email, nome: @aluno.nome } }
